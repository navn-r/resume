...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */;function U(t){let e=E.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},E.set(t.type,e));let i=e.stringsArray.get(t.strings);if(void 0!==i)return i;const n=t.strings.join(s);return i=e.keyString.get(n),void 0===i&&(i=new r(t,t.getTemplateElement()),e.keyString.set(n,i)),e.stringsArray.set(t.strings,i),i}const E=new Map,T=new WeakMap;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class{handleAttributeExpressions(t,e,i,s){const n=e[0];if("."===n){return new k(t,e.slice(1),i).parts}return"@"===n?[new _(t,e.slice(1),s.eventContext)]:"?"===n?[new j(t,e.slice(1),i)]:new C(t,e,i).parts}handleTextExpression(t){return new M(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
const at=new WeakMap,ct=(lt=t=>e=>{if(!(e instanceof M))throw new Error("unsafeHTML can only be used in text bindings");const i=at.get(e);if(void 0!==i&&x(t)&&t===i.value&&e.value===i.fragment)return;const s=document.createElement("template");s.innerHTML=t;const n=document.importNode(s.content,!0);e.setValue(n),at.set(e,{value:t,fragment:n})},(...t)=>{const e=lt(...t);return m.set(e,!0),e});var lt,ht=function(t,e,i,s){for(var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let dt=class extends it{constructor(){super(...arguments),this.name="Experience",this.subtitle="summary/degree/position",this.location="",this.time="",this.isProject="",this.repo=""}render(){return I`
  ...
  `,ht([Q({type:String})],dt.prototype,"name",void 0),ht([Q({type:String})],dt.prototype,"subtitle",void 0),ht([Q({type:String})],dt.prototype,"location",void 0),ht([Q({type:String})],dt.prototype,"time",void 0),ht([Q({type:String})],dt.prototype,"isProject",void 0),ht([Q({type:String})],dt.prototype,"repo",void 0),dt=ht([W("experience-card")],dt);var ut={firstName:"Navinn",lastName:"Ravindaran",contact:{portfolio:"navn.me",email:"navinn.ravindaran@mail.utoronto.ca",linkedIn:"navinn-ravindaran",github:"navn-r"}},pt=["<strong>Programming:</strong> HTML, CSS, TypeScript, JavaScript, Java, C, Python, Shell, LaTeX","<strong>Frameworks and Tools:</strong> Angular, React, React Native, Node.js, Express.js, Jira, Git, GitHub Actions, TravisCI, MongoDB, Firebase","<strong>Development Methodology:</strong> Agile Scrum, Agile Kanban"],mt=[{school:"University of Toronto",degree:"Honours Bachelor of Science, Computer Science & Statistics Co-op",location:"Toronto, ON",duration:"Sept. 2019 — Apr. 2023 (Expected)",cgpa:"3.78 / 4.00",courses:["Software Design","Intro to Software Engineering","Discrete Mathematics","Multivariable Calculus","Linear Algebra"],awards:["<strong>Dean's List of Academic Excellence</strong> (2019-20)","<strong>University of Toronto Scholar</strong> ($7500)</li>"]}],ft=[{position:"Software Developer",employer:"CaseWare International Inc. &bull; Co-op",location:"Toronto, ON",duration:"Sept. 2020 — Apr. 2021",accomplishments:["Active contributor in an <strong>Agile Scrum</strong> of 11 members, closely collaborating with developers, QA, managers and product owners","Facilitated <strong>Daily Standup</strong> meetings using various Sprint, Regression, and On Call <strong>Jira</strong> Boards","Decreased developer & QA regression efforts by <strong>60%</strong> by converting manual tests to unit tests with <strong>Karma</strong> and <strong>Jasmine</strong>",'Developed major features and hot<span class="space">f</span>ixes using <strong>Angular, AngularJS</strong> and <strong>TypeScript</strong> improving the end-user experience for <strong>60+</strong> international distributors']}],gt=[{name:"UImpactify",date:"Sept. 2020 — Dec. 2020",shortDesc:"Online Learning Platform",repoUrl:"https://github.com/navn-r/uimpactify",demoUrl:"uimpactify.herokuapp.com",accomplishments:["Developed in an Agile Scrum of <strong>7</strong> members over 4 sprints, specializing in education for the social purpose sector",'Facilitated Daily Standup, Backlog Re<span class="space">f</span>inement, and Software Architecture Design meetings following best Agile practices',"Developed and implemented a Discord Bot to supplement Daily Standup Meetings, reducing overall meeting time by <strong>50%</strong>","Well received by product owners and competitors, resulting in a score of <strong>99%</strong>"],features:["Courses","Graded Assessments","Student Analytics","Surveys & Ratings","Realtime Chat","Volunteer & Employment Opportunities and a Community-driven Donation System"],technology:["MongoDB","Express.js","Angular","Node.js","Clarity Design","Socket.io","Chart.js","Multer","GridFS","Figma","Jira"]},{name:"Spotify API Clone",date:"Nov. 2020 — Dec. 2020",shortDesc:"Social-centric Music Player Backend",repoUrl:"https://github.com/navn-r/spotify-api-clone",demoUrl:"navn.me/spotify-api-clone",accomplishments:[],features:['Creating and following user pro<span class="space">f</span>iles',"Uploading and liking songs","Playlist generation and Querying liked songs from followers"],technology:["Java","Spring Boot","MongoDB","Neo4j","Microservices architecture"]},{name:"Ritrovo",date:"Sept. 2020",shortDesc:"Full-Stack Social Platform",repoUrl:"https://github.com/navn-r/ritrovo",demoUrl:"ritrovo.herokuapp.com",accomplishments:[],features:["Create, Edit, View, and Delete posts made by other users in a single-community based dashboard"],technology:["MongoDB","Express.js","Angular","Node.js","Markdown","Bootstrap","Heroku"]},{name:"Noten",date:"May 2020",shortDesc:"Cloud Based Grade Management Application",repoUrl:"https://github.com/navn-r/noten",demoUrl:"play.google.com/store/apps/details?id=com.noten",accomplishments:["Developed using a single codebase, deployable to both <strong>iOS</strong> and <strong>Android</strong>","Implemented a flattened data store, resulting in <strong>4x</strong> fewer database queries for standard CRUD operations on grades"],features:["Multi-Semester and Course Management","Grade Prediction Calculator","Pass/Fail Courses","Multiple Grade Scales and Incognito Grades (Ignore Grade during GPA calculations)"],technology:["React Native","Firebase Realtime Database","Firebase Authentication with Google OAuth 2.0"]}],vt=function(t,e,i,s){for(var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};t.Resume=class extends it{render(){return I`
