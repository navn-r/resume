...
`;var ht=function(t,e,i,s){for(var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let dt=class extends it{render(){return U`
  ...
  `],wt([K({type:Array})],yt.prototype,"skills",void 0),yt=wt([q("skills-card")],yt);var bt=function(t,e,i,s){for(var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let St=class extends it{render(){return U`
      <div class="work-card">
        <div class="title-container">
          ...
          <h4>${at(this.work.startDate)} — ${at(this.work.endDate)}</h4>
        </div>
        <ul class="body">
          ${this.work.highlights.map(t=>U`<li>${rt(t)}</li>`)}
        </ul>
      </div>
    `}};St.styles=[ct,lt],bt([K({type:Object})],St.prototype,"work",void 0),St=bt([q("work-card")],St);var $t=function(t,e,i,s){for(var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};const xt={$schema:"https://raw.githubusercontent.com/jsonresume/resume-schema/v1.0.0/schema.json",basics:{name:"Navinn Ravindaran",label:"Developer, Learner",email:"navinn.ravindaran@mail.utoronto.ca",url:"https://navn.me",location:{city:"Toronto",region:"Ontario",countryCode:"CA"},profiles:[{network:"GitHub",username:"navn-r",url:"https://github.com/navn-r"},{network:"LinkedIn",username:"navn-r",url:"https://www.linkedin.com/in/navn-r"}]},work:[{name:"CaseWare International Inc.",location:"Toronto, ON",position:"Software Developer Co-op",url:"https://www.caseware.com/ca",startDate:"2020-09-08",endDate:"2021-04-30",highlights:["Active contributor in an **Agile Scrum** of **11** members, closely collaborating with developers, manual & automation QA and product owners","Facilitated **Daily Standup** meetings using various Sprint, Regression, and On Call **Jira** Boards","Decreased developer & QA regression efforts by **60%** by converting manual tests to unit tests with **Karma, Jasmine** and **TypeScript**","Developed major features and hotfixes using **Angular, AngularJS, RxJS** and **NGXS** improving the end-user experience for **60+** international distributors"]}],education:[{institution:"University of Toronto",location:"Toronto, ON",url:"https://www.utoronto.ca/",area:"Computer Science & Statistics Co-op",studyType:"Honours Bachelor of Science",startDate:"2019-09-08",endDate:"2023-04-30",score:"3.78 / 4.00",courses:["Software Design","Software Engineering","Programming Languages","Software Tools and Systems Programming"],awards:["Dean's List of Academic Excellence (2019-20)","University of Toronto Scholar ($7500)"]}],skills:[{name:"Programming",keywords:["HTML","CSS","TypeScript","JavaScript","Java","C","Python","Shell","LaTeX"]},{name:"Frameworks and Tools",keywords:["Angular","React","React Native","Node.js","Express.js","JIRA","GitHub Actions","TravisCI","MongoDB","Firebase"]},{name:"Development Methodologies",keywords:["Agile Scrum","Agile Kanban","Test Driven Development"]}],projects:[{name:"UImpactify",description:"Online Learning Platform",highlights:["Engaged in an Agile Scrum of **7** members over **4** sprints, specializing in education for the social purpose sector","Facilitated Daily Standup, Backlog Refinement, and Architecture Design meetings **following best Agile practices**","Developed and deployed a **Discord Bot** to supplement Daily Standup meetings, reducing overall time by **50%**"],startDate:"2020-09",endDate:"2020-12",repo:"https://github.com/navn-r/uimpactify",url:"https://uimpactify.herokuapp.com",type:"Website",features:["Course Enrollment","Lectures & Assessments","Student Analytics","Course Surveys","Realtime Chat","Volunteer Opportunities","Donation System"],technology:["MongoDB","Express.js","Angular","Node.js","Clarity Design","Socket.io","Chart.js","Multer","GridFS","Figma","JIRA"]},{name:"Spotify API Clone",description:"Social-centric Music Player REST API",highlights:[],startDate:"2020-11",endDate:"2020-12",repo:"https://github.com/navn-r/spotify-api-clone",url:"https://navn.me/spotify-api-clone",type:"Documentation",features:["Create and follow user profiles","Upload and like songs","Playlist generation","Query liked songs from followers"],technology:["Java","Spring Boot","MongoDB","Neo4j","Microservices Architecture"]},{name:"Ritrovo",description:"Full-Stack Social Platform",highlights:["Built a **REST API** and community dashboard for creating posts and collaborating with users authenticated with **Password Hashing**"],startDate:"2020-09",endDate:"2020-09",repo:"https://github.com/navn-r/ritrovo",url:"https://ritrovo.herokuapp.com",type:"Website",technology:["MongoDB","Express.js","Angular","Node.js","bcrypt","Mongoose","Markdown","Heroku"]},{name:"Noten",description:"Cloud Based Grade Management Application",highlights:["Developed using a single codebase, deployable to both **iOS** and **Android**","Implemented a flattened data store, resulting in **4x** fewer database queries on all **CRUD** operations on grades"],startDate:"2020-04",endDate:"2020-05",repo:"https://github.com/navn-r/noten",url:"https://play.google.com/store/apps/details?id=com.noten",type:"Google Play Store",features:["Multi-Semester & Course Management","Grade Prediction","Pass/Fail Courses","Multiple Grade Scales","Selective Grade Calculation"],technology:["React Native","Firebase Realtime Database","Firebase Authentication with Google OAuth 2.0"]}]};t.Resume=class extends it{render(){return U`
      <app-header .basics="${xt.basics}"></app-header>
      <div class="section">
        <h1 class="title">Education</h1>
        ${xt.education.map(t=>U`<education-card .education="${t}"></education-card>`)}
      </div>
      <div class="section">
        <h1 class="title">Skills</h1>
        <skills-card .skills="${xt.skills}"></skills-card>
      </div>
      <div class="section">
        <h1 class="title">Work Experience</h1>
        ${xt.work.map(t=>U`<work-card .work="${t}"></work-card>`)}
      </div>
      <div class="section">
        <h1 class="title">Projects</h1>
        ${xt.projects.map(t=>U`<project-card .project="${t}"></project-card>`)}
      </div>
    `}},t.Resume.styles=tt`
    :host {
      font-family: var(--main);
  ...
  `,t.Resume=$t([q("app-resume")],t.Resume)}({});
