...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
class lt extends class{constructor(t){}T(t,i,e){this.Σdt=t,this.M=i,this.Σct=e}S(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}{constructor(t){if(super(t),this.vt=U,t.type!==at)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===U)return this.Vt=void 0,this.vt=t;if(t===z)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.vt)return this.Vt;this.vt=t;const i=[t];return i.raw=i,this.Vt={_$litType$:this.constructor.resultType,strings:i,values:[]}}}lt.directiveName="unsafeHTML",lt.resultType=1;const ct=(t=>(...i)=>({_$litDirective$:t,values:i}))(lt),ht=t=>ct(t.replace(/fi/g,'<span style="margin-right: 0.25px">f</span>i').replace(/(\*\*|__)(.*?)\1/gim,"<strong>$2</strong>")),dt=(t,i={month:"short",year:"numeric"})=>new Date(t).toLocaleString("default",i),ut=r`
  .card {
